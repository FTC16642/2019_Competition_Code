...
public class AutonomousRed extends LinearOpMode {
    ...
    public void runOpMode() {
...

        {
            ...
            drive.moveRight(16, drive.medium);
            ...
            drive.moveForward(-33, drive.medium);

            //move closer to the back wall
            //while( backDistSensor.getDistance() < 8190 )
            {
                // corrects strafing
                if(sideDistSensor.getDistance() > 800 )
                {
            ...
            //drive.moveForward(10 , drive.medium);
            hook.pullUp();
            drive.turnClockwise(23, drive.medium);
            drive.moveForward(27 , drive.medium);
