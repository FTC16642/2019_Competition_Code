...
@Autonomous(name="RedLeftFar", group="Linear Opmode")

public class RedLeftFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        grabber.up();
        drive.moveForward(-17 , drive.medium);
        drive.moveRight(14, drive.medium); 
